...
class CrearAlquilerForm(forms.Form):
    ...
    def is_valid(self) -> bool:
        ...
        valid = super().is_valid() and afiliadoForm.is_valid() and salonForm.is_valid() and alquilerForm.is_valid()
    ...
    def save(self, commit=False):
        ...
        self.alquiler.agregarAlquiler(salon, alquiler.senia, alquiler.reserva, alquiler.inicio, afiliado) #.agregarAlquiler(salon, alquiler.senia, alquiler.reserva, alquiler.inicio, afiliado)
        return alquiler
