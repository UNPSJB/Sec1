...
urlpatterns = [
    ...
    path('agregarAfiliado/', agregarAlumno, name='agregarAfiliado'),
    ...
    path('listadoProfesores/', include('apps.cursos.urls')),
    ...
    path('servicios/', include('apps.salones.urls')),
    path('afiliados/', include('apps.afiliados.urls')),
    path('profesor/', include('apps.cursos.urls')),
    path('alumnos/', include('apps.cursos.urls')),
    path('cursos/', include('apps.cursos.urls')),
    path('clases/', include('apps.cursos.urls')),
    path('aulas/', include('apps.cursos.urls')),
]
